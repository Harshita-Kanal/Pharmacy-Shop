...
<form method="POST" action = "{{ route('users.update') }}" >    
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control"  value = "{{ old('name', $user->name) }}"   name="name" placeholder = "name"  autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email" value = "{{ old('email', $user->email) }}"   placeholder = "Email Address">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <small id="emailHelp" class="form-text text-muted">Leave it blank to keep the current password</small>
                            </div>
                        </div>
